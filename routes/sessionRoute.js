...
router.put('/:sessionId/normal', permissionMiddleware('edit_session', 'finalize_session'), validateIdParam('sessionId'), sessionValidate.edit, sessionController.editNormal);
...
router.delete('/:sessionId/images/:imageId', permissionMiddleware('edit_session', 'delete_session', 'finalize_session'), validateIdParam('sessionId'), validateIdParam('imageId'), sessionImageController.remove);
