...
async function getWorksForSessions(sessionIds) {
...
export default {
  createSession, getAllSessions, getSession, updateSession, deleteSession, createSessionWork, updateSessionTotal, getAllUnPaidSessions, getWorksForSessions,
  getSessionWithAppointment, getTreatmentPlansForSession, getSessionPaymentContext, getSessionWithAppointmentForUpdate,
  getTreatmentPlansForSessions, hasPlanDue
}